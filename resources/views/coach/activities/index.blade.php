...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="mt-8">
        <div class="bg-gray-900 shadow rounded-lg border border-gray-800">
            <div class="px-6 py-4 flex flex-col sm:flex-row justify-between items-center border-b border-gray-800">
                <h3 class="text-lg font-semibold text-light mb-4 sm:mb-0">Mes Activités</h3>
                <a href="{{ route('coach.activities.create') }}" class="btn-primary inline-flex items-center">
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="flex space-x-2">
                                            <a href="{{ route('coach.activities.show', $activity) }}" 
                                               class="p-2 bg-primary text-dark rounded-full hover:bg-primary-dark transition-all duration-300" title="Voir">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                            ...
                                            <a href="{{ route('coach.activities.edit', $activity) }}" 
                                               class="p-2 bg-primary text-dark rounded-full hover:bg-primary-dark transition-all duration-300" title="Modifier">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                            ...
                                            <form action="{{ route('coach.activities.destroy', $activity) }}" method="POST" onsubmit="return confirm('Êtes-vous sûr de vouloir supprimer cette activité ?')">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit" class="p-2 bg-red-500 text-white rounded-full hover:bg-red-600 transition-all duration-300" title="Supprimer">
                                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                ...
                                <tr>
                                    <td colspan="6" class="px-6 py-8 text-center text-gray-400">
                                        <div class="flex flex-col items-center justify-center">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-12 w-12 mb-4 text-gray-500" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1" stroke-linecap="round" stroke-linejoin="round">
...
<style>
    ...
    .p-2.bg-primary, .p-2.bg-red-500 {
        transform: scale(1);
        transition: transform 0.2s ease, background-color 0.3s ease;
    }
    
    .p-2.bg-primary:hover, .p-2.bg-red-500:hover {
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        tableRows.forEach(row => {
            ...
            row.addEventListener('mouseleave', function() {
                if (!this.classList.contains('hover:bg-gray-800')) {
