        ...
        <form action="{{ route('admin.users.update', $user) }}" method="POST">
            ...
            <div class="mb-6">
                <label for="password" class="block text-sm font-medium mb-2">
                    ...
                    <span class="text-gray-400">(laisser vide pour ne pas modifier)</span>
                </label>
            ...
            <div class="mb-6">
                <label for="password_confirmation" class="block text-sm font-medium mb-2">Confirmer le nouveau mot de passe</label>
