                ...
                <form action="{{ route('profile.complete') }}" method="POST" class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                        <div>
                            ...
                            <select id="genre" name="genre" class="mt-1 block w-full pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-primary focus:border-primary sm:text-sm rounded-md">
                        ...
                        <div>
                            ...
                            <input type="number" name="age" id="age" value="{{ old('age') }}" class="mt-1 focus:ring-primary focus:border-primary block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                        </div>

                        <div>
                            <label for="taille" class="block text-sm font-medium text-gray-700">Taille (cm)</label>
                            <input type="number" name="taille" id="taille" value="{{ old('taille') }}" class="mt-1 focus:ring-primary focus:border-primary block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                        </div>

                        <div>
                            <label for="poids" class="block text-sm font-medium text-gray-700">Poids (kg)</label>
                            <input type="number" name="poids" id="poids" value="{{ old('poids') }}" class="mt-1 focus:ring-primary focus:border-primary block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                        </div>

                        <div>
                            <label for="niveau_activite" class="block text-sm font-medium text-gray-700">Niveau d'activité</label>
                            <select id="niveau_activite" name="niveau_activite" class="mt-1 block w-full pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-primary focus:border-primary sm:text-sm rounded-md">
                        ...
                        <div>
                            ...
                            <select id="objectif_principal" name="objectif_principal" class="mt-1 block w-full pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-primary focus:border-primary sm:text-sm rounded-md">
